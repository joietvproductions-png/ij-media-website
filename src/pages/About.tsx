      ...
      <StackSection index={0} total={totalSections} bgColor="gradient-bg-animated grain relative">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          <div className="container mx-auto px-6 text-center max-w-5xl">
            ...
            >
              We Don't Just Document Nigeria. <br /> 
              We <span className="text-hotRose italic">Amplify</span> It.
            </motion.h1>
            <motion.p 
        ...
        <div className="container mx-auto px-6 py-24 min-h-screen flex flex-col justify-center">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-6xl font-syne font-bold leading-tight">The reason we tell these stories.</h2>
            ...
            >
              <div className="space-y-4">
                <img src="https://images.unsplash.com/photo-1554080353-a576cf803bda?auto=format&fit=crop&q=80&w=600" alt="" className="w-full h-80 object-cover rounded-3xl" />
                <img src="https://images.unsplash.com/photo-1604431696980-07e518647c95?auto=format&fit=crop&q=80&w=600" alt="" className="w-full h-48 object-cover rounded-3xl" />
              </div>
              <div className="pt-12">
                <img src="https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?auto=format&fit=crop&q=80&w=600" alt="" className="w-full h-full object-cover rounded-3xl" />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <StackSection index={2} total={totalSections} bgColor="bg-frostedBlue">
        <div className="container mx-auto px-6 py-24 min-h-screen flex flex-col justify-center text-pitchBlack">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-syne font-bold">The minds behind IJ Media.</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            {founders.map((founder, i) => (
              ...
              >
                <img src={founder.img} alt={founder.name} className="w-48 h-48 rounded-full object-cover mb-6 border-4 border-hotRose/20" />
      ...
      <StackSection index={3} total={totalSections} bgColor="bg-midnightViolet">
        <div className="container mx-auto px-6 py-24 min-h-screen flex flex-col justify-center text-softWhite">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-syne font-bold">What guides our work.</h2>
          </div>
      ...
      <StackSection index={4} total={totalSections} bgColor="bg-cerulean">
        <div className="container mx-auto px-6 py-32 min-h-[50vh] flex flex-col md:flex-row justify-between items-center gap-8 text-softWhite">
          <div>
            ...
            <h2 className="text-4xl md:text-6xl font-syne font-bold leading-tight">Have a story that needs to be told?</h2>
          </div>
