...
const Works = () => {
  ...
  const processSteps = [
    { 
      number: "01", 
      title: "Research", 
      desc: "We dive deep into the story — interviewing experts, communities, and stakeholders to uncover the truth that needs telling.",
      icon: Search
    },
    { 
      number: "02", 
      title: "Pre-Production", 
      desc: "Script development, location scouting, ethical clearances, and partnership building with NGOs and subject communities.",
      icon: FileText
    },
    { 
      number: "03", 
      title: "Filming", 
      desc: "Mobile-first cinematic capture using lightweight gear to maintain intimacy and authenticity with subjects.",
      icon: Camera
    },
    { 
      number: "04", 
      title: "Distribution", 
      desc: "Multi-platform release strategy — from social media to film festivals to policy briefings — to maximize impact.",
      icon: Megaphone
    },
  ];
  ...
  // Replace this YouTube ID with your actual showreel video ID later
      ...
      <StackSection index={0} total={totalSections} bgColor="gradient-bg-animated grain relative">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          <div className="container mx-auto px-6 text-center max-w-4xl">
            ...
            >
              Stories that <span className="text-hotRose italic">move</span>.
            </motion.h1>
            <motion.p 
            ...
            {/* Watch Showreel Button — Opens Modal */}
            <motion.button
      ...
      <StackSection index={2} total={totalSections} bgColor="bg-frostedBlue">
        <div className="container mx-auto px-6 py-24 min-h-screen flex flex-col justify-center text-pitchBlack">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-6xl font-syne font-bold">How we bring stories to life.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {processSteps.map((step, i) => (
              ...
              >
                ...
                {/* Connecting Arrow (visible on desktop, except last card) */}
        ...
        <div className="container mx-auto px-6 py-24 min-h-screen flex flex-col justify-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div 
              ...
              onClick={() => setIsVideoOpen(true)}
            >
              <img src="https://images.unsplash.com/photo-1574267432553-4b4628081c31?auto=format&fit=crop&q=80&w=1200" alt="Featured" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:opacity-60 transition-opacity" />
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <h2 className="text-4xl md:text-5xl font-syne font-bold mb-6">
                The Silent Struggle: Mental Health in Lagos
              </h2>
      ...
      <StackSection index={4} total={totalSections} bgColor="bg-pitchBlack">
        <div className="py-24 min-h-screen flex flex-col justify-center">
          <div className="container mx-auto px-6 mb-12">
            ...
            <h2 className="text-4xl md:text-6xl font-syne font-bold">The moments between the moments.</h2>
          </div>
          <div className="flex gap-6 overflow-x-auto px-6 pb-6 scrollbar-hide">
            {btsImages.map((img, i) => (
              ...
              >
                <img src={img} alt={`BTS ${i+1}`} className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-500 hover:scale-105" />
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <StackSection index={5} total={totalSections} bgColor="bg-hotRose">
        <div className="container mx-auto px-6 py-32 min-h-[50vh] flex flex-col md:flex-row justify-between items-center gap-8 text-softWhite">
          <div>
            ...
            <h2 className="text-4xl md:text-6xl font-syne font-bold leading-tight">Want to collaborate on a project?</h2>
          </div>
